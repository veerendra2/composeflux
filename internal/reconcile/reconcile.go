...
type Config struct {
	...
	PruneInterval       time.Duration `name:"prune-interval" help:"Interval for periodic Docker resource pruning (only runs when all stacks are healthy)" env:"PRUNE_INTERVAL" default:"24h" group:"Reconciler Options:"`
}
